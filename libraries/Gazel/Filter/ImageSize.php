...
/**
 * @see Gazel_Filter_ImageSize_Strategy_Fit
 */
require_once 'Gazel/Filter/ImageSize/Strategy/Fit.php';

/**
 * Filter for resizing images.  
 */
class Gazel_Filter_ImageSize implements Zend_Filter_Interface
{
    /**
    ...
    /**
     * Resizing strategy.
     * @var Gazel_Filter_ImageSize_Strategy_Interface
     */
     ...
     * @return Gazel_Filter_ImageSize Fluent interface
     */
     ...
     * @param Gazel_Filter_ImageSize_Strategy_Interface $strategy
     * @return Gazel_Filter_ImageSize Fluent interface
     */
    public function setStrategy(Gazel_Filter_ImageSize_Strategy_Interface $strategy)
    {
     ...
     * @return Gazel_Filter_ImageSize_Strategy_Interface
     */
    public function getStrategy()
    {
        if(is_null($this->_strategy)) {
            $this->_strategy = new Gazel_Filter_ImageSize_Strategy_Fit();
        }
