...
/**
 * @see Gazel_Filter_ImageSize_Strategy_Interface 
 */
require_once 'Gazel/Filter/ImageSize/Strategy/Interface.php';

/**
 * Strategy for resizing the image so that its smalles edge fits into the frame.
 * The rest is cropped.
 */
class Gazel_Filter_ImageSize_Strategy_Crop 
    implements Gazel_Filter_ImageSize_Strategy_Interface
{
    /**
